...
public class StudentJoinDTO {
	...
	String absence_yn;
	String coach_professor_no;
	List<GradeDTO> gradeList;
	
	public StudentJoinDTO() {}
	...
	public StudentJoinDTO(String student_no, String department_no, String student_name, String student_ssn,
	...
	public String toString() {
		return "StudentJoinDTO [student_no=" + student_no + ", department_no=" + department_no + ", student_name="
				...
				+ coach_professor_no + ", gradeList=" + gradeList + "]";
	}
